...
class MediaPlayer:
   ...
   def soundAlarm(self, alarmThread):
      ...
      if num < 2 and self.player is not False:
         log.error("Could not find VLC instance, playing panic alarm")
         self.stopPlayer()
         time.sleep(2)
   ...
   def playStation(self,station=-1):
      ...
      #stationurl = 'http://13873.live.streamtheworld.com:443/FM947_SC'
      stationname= '947'
      ...
      media = self.instance.media_new('http://13873.live.streamtheworld.com:443/FM947_SC')
