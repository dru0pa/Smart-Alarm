...
class Settings:
    ...
    DEFAULTS = [
        ...
        ('wakeup_time', '75'),
        # Time (mins) before event that alarm should be triggered (excluding travel time) (30 mins pre-shift + 45 mins wakeup)
        ...
        ('location_work', 'Sloane Street, Sandton, South Africa'),
        # Default location for work (if lookup from event fails)
