...
class Settings:
    ...
    DEFAULTS = [
        ...
        ('manual_alarm','0645'),  # Manual alarm time (default not set)
        ...
        ('location_home','Thornhill Road, Lethabong, South Africa'),  # Location for home
        ('location_work','Sloane Street, Sandton, South Africa'), # Default location for work (if lookup from event fails)
        ('tts_path', '/user/bin/festival --tts'),  # The command we pipe our TTS output into
    ]
